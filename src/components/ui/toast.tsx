...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed z-[200] flex max-h-screen w-full flex-col-reverse p-4 sm:right-4 sm:top-4 sm:flex-col md:max-w-[420px]", 
      /* Changed to position toasts at top-right with higher z-index to ensure they don't overlap with critical content */
      className
    )}
    {...props}
  />
...
const toastVariants = cva(
  ...
  /* Changed from bottom-full to top-full for animation direction to match new positioning */
  {
    variants: {
      variant: {
