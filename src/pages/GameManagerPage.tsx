...
const defaultGames: Game[] = [
    {
        ...
        version: "1.0.0",
        updated: "2025-05-17",
        thumbnail: "/public/tetris-preview.gif",
        componentId: "tetris",
    },
    {
        id: "ikari",
        ...
        version: "1.0.0",
        updated: "2025-05-17",
        thumbnail: "/public/ikari-preview.png",
        componentId: "ikari",
    },
    {
        id: "tamagotchi",
...
const GameManagerPage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen w-full flex flex-col items-center justify-center bg-gradient-to-br from-black via-gray-900 to-black">
            {/* Desktop Sidebar */}
            ...
            <main className="flex-1 flex flex-col items-center justify-center w-full max-w-6xl px-4 py-12">
                ...
                <div className="w-full grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                    <div className="bg-white/5 backdrop-blur rounded-2xl shadow-xl border border-white/10 p-6 flex flex-col items-start animate-fade-in">
                ...
                {featuredGame && (
                    <div className="w-full flex flex-col md:flex-row items-center bg-white/10 rounded-2xl shadow-xl border border-white/10 mb-10 p-6 gap-6 animate-fade-in">
                        <img src={featuredGame.thumbnail} alt={featuredGame.name} className="w-32 h-32 rounded-xl grayscale hover:grayscale-0 border-2 border-white/20 shadow-lg transition-all duration-300" />
                        <div className="flex-1 flex flex-col gap-2">
                            ...
                            <div className="flex gap-2 items-center">
                                <button className="px-4 py-2 rounded-lg bg-black text-white font-semibold shadow hover:bg-gray-800 border border-white/10">Play Now</button>
                ...
                <div className="w-full flex gap-4 mb-6">
                    <input
                        ...
                        className="px-4 py-2 rounded-lg bg-black text-white border border-white/10 focus:outline-white focus:ring-2 focus:ring-white"
                ...
                {/* --- Upload Button --- */}
                <button
                    className="fixed bottom-8 right-8 z-50 px-6 py-3 bg-white text-black rounded-full shadow-xl font-bold text-lg border border-white/20 hover:bg-gray-200 transition"
